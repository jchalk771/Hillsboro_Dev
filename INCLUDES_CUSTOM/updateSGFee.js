function updateSGFee(fcode, fsched, SubGrp) {
	try{
			...
			for (feeNum in feeList) {
				if (feeList[feeNum].getFeeitemStatus().equals("INVOICED")) {
					...
					if (pDuplicate == "Y") {
						...
						//@TODO is companion check variable going to cause an issue if this is called independent of other two functions?
		...
		logDebug("A JavaScript error has occurred in custom function updateSGFee: " + err.message + "In line number: " + err.lineNumber);
	}
}