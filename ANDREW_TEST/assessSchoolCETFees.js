function assessSchoolCETFees(schoolDistrict, appDate, resSqFt, comSqFt) {
...
/*
 * Custom Function removeSchoolCETFees
 * To be called from event if School Fees do not apply.
 * Call in event script after assessSchoolCETFees
