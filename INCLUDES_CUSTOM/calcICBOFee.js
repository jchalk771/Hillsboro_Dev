function calcICBOFee(calcVariable, capval) {
	try {
		...
		logDebug("A JavaScript error has occurred in custom function calcICBOFee: " + err.message + "In line number: " + err.lineNumber);
	}
}